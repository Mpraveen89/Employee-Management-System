...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>" class="logo">
      ...
      <span class="logo-lg">
        <img src="<?php echo base_url('assets/images/ems logo.jpg'); ?>"
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url(); ?>assets/dist/img/userav1.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Staff</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url(); ?>assets/dist/img/userav1.png" class="img-circle" alt="User Image">
                <p>
                  Employee
                  <small>Since Dec, 2025</small>
                </p>
              </li>
              <!-- Menu Footer-->
